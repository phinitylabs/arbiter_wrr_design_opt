...
module arbiter_wrr_lock #(
    ...
    logic [NUM_CLIENTS*2-1:0][WEIGHT_WIDTH-1:0] weight_packed;
    
    // State Registers
    logic [NUM_CLIENTS*2-1:0]          current_gnt;
    logic [$clog2(NUM_CLIENTS*2)-1:0]  current_ptr;
    ...
    logic                            keep_current;
    logic                            found_next;
    logic [$clog2(NUM_CLIENTS*2)-1:0]  next_ptr_search;
    logic [NUM_CLIENTS*2-1:0]          next_gnt_search;
